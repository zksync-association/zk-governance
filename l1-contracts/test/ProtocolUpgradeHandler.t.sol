...
contract TestProtocolUpgradeHandler is Test {
  ...
  constructor() {
    ...
    handler = _deployProtocolUpgradeHandler(
      securityCouncil,
      guardians,
  ...
  function _deployProtocolUpgradeHandler(
    address securityCouncil,
    address guardians,
    address emergencyUpgradeBoard,
    address l2ProtocolGovernor,
  ...
  function test_constructorEvents() public {
    ...
    ProtocolUpgradeHandler testHandler = _deployProtocolUpgradeHandler(
      securityCouncil,
      guardians,
      emergencyUpgradeBoard,
      l2ProtocolGovernor,
  ...
  function testExecuteMsgSenderAuthorized(
    ...
    bytes32 id = _startUpgrade(proposal);
    _makeUpgradeReady(_extendedLegalPeriod, _approvedByGuardians, _approvedBySecurityCouncil, id, _delayAfterApprove);
  ...
  function test_unfreezeAfterSoftFreezeSecurityCouncil(uint256 _ufreezeAfter) public {
    ...
    handler.unfreeze();
    assertEq(
      uint256(handler.lastFreezeStatusInUpgradeCycle()), uint256(IProtocolUpgradeHandler.FreezeStatus.AfterSoftFreeze)
    );
